...
```
java -Dspring.profiles.active=production -jar ./target/skeletoFront-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=br.jus.stj.enfam/skeleto-front
```
